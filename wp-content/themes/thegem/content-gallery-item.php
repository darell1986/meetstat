	...
	<div class="wrap <?php if($params['type'] == 'grid' && $params['item_style'] != ''): ?> gem-wrapbox-style-<?php echo esc_attr($thegem_wrap_classes); ?><?php endif; ?>">
		...
		<div class="overlay-wrap">
			<div class="image-wrap <?php if($params['type'] == 'grid' && $params['item_style'] == '11'): ?>img-circle<?php endif; ?>">
				<img src="<?php echo esc_url($thegem_small_image_url[0]); ?>" <?php if($params['type'] == 'slider'): ?>data-thumb-url="<?php echo esc_url($thegem_thumb_image_url[0]); ?>"<?php endif; ?> <?php if($params['type'] == 'grid'): ?>width="<?php echo esc_attr($thegem_small_image_url[1]); ?>" height="<?php echo esc_attr($thegem_small_image_url[2]); ?>"<?php endif; ?> alt="<?php echo get_post_meta($thegem_item->ID, '_wp_attachment_image_alt', true); ?>">
			</div>
